...
CREATE TABLE `gms_brand` (
  ...
  `name` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '品牌名称',
  `description` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '品牌描述',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='商品品牌表';
...
CREATE TABLE `gms_goods` (
  ...
  `pinyin` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '商品拼音',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='商品表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gms_goods_category` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='商品分类表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `oms_expenditure` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='支出表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oms_expenditure` VALUES (1,'找烟1',1001,'money','2023-09-15 17:07:24','money','2023-09-15 17:07:32','此乃备注2'),(1703645721571000320,'新君2',1,'money','2023-09-18 13:42:47','money','2023-09-18 13:42:47','11');
...
CREATE TABLE `oms_order` (
  ...
  `contact` varchar(24) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '联系方式',
  ...
  `settle_account_remark` varchar(255) DEFAULT NULL COMMENT '清账备注',
  `arrears_account` decimal(10,2) unsigned DEFAULT NULL COMMENT '清账金额',
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='订单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oms_order` VALUES (1701524747019010048,'202309121714466','ARREARS','',40.40,85.00,85.00,86.00,'',NULL,1199.00,'2023-09-12 17:14:46',NULL,'money','2023-09-12 17:14:47','money','2023-09-12 17:14:47'),(1701869394908102656,'202309131604162','RETURN','',3.47,9.00,9.00,0.00,'',NULL,NULL,'2023-09-13 16:04:17',NULL,'money','2023-09-13 16:04:18','money','2023-09-13 16:04:18'),(1703648878606888960,'202309181355192','RETURN','',11.00,12.00,12.00,0.00,'',NULL,NULL,'2023-09-18 13:55:20',NULL,'money','2023-09-18 13:55:20','money','2023-09-18 13:55:20'),(1703651946442469376,'202309181407310','PAID','',360.00,400.00,400.00,0.00,'',NULL,NULL,'2023-09-18 14:07:31',NULL,'money','2023-09-18 14:07:31','money','2023-09-18 14:07:31'),(1703679777574694912,'202309181558064','PAID','',360.00,400.00,200.00,200.00,'',NULL,NULL,'2023-09-18 15:58:06',NULL,'money','2023-09-18 15:58:06','money','2023-09-18 15:58:06'),(1703698161502748672,'202309181711098','PAID','',11.00,12.00,99.00,0.00,'',NULL,NULL,'2023-09-18 17:11:10',NULL,'money','2023-09-18 17:11:10','money','2023-09-18 17:11:10'),(1703952545440509952,'202309191001597','PAID','',360.00,400.00,400.00,400.00,'',NULL,NULL,'2023-09-19 10:01:59',NULL,'money','2023-09-19 10:01:59','money','2023-09-19 10:01:59');
...
CREATE TABLE `oms_order_detail` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='订单明细表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oms_order_detail` VALUES (1701524747069341696,'202309121714466','RETURN',1488355061607174146,'重油污净',18.00,2,18.00,7.20,2,'money','2023-09-12 17:14:47','money','2023-09-12 17:14:47'),(1701524747077730304,'202309121714466','RETURN',1488082288095838209,'女士士私护贴',49.00,1,49.00,26.00,1,'money','2023-09-12 17:14:47','money','2023-09-12 17:14:47'),(1701869394958434304,'202309131604162','RETURN',1488070478168899586,'日用',9.00,1,9.00,3.47,1,'money','2023-09-13 16:04:18','money','2023-09-13 16:04:18'),(1703648878644637696,'202309181355192','RETURN',1701776231627407360,'软',12.00,1,12.00,11.00,1,'money','2023-09-18 13:55:20','money','2023-09-18 13:55:20'),(1703651946517966848,'202309181407310','RETURN',1702191951548948480,'硬和谐',400.00,1,400.00,360.00,1,'money','2023-09-18 14:07:31','money','2023-09-18 14:07:31'),(1703679777583083520,'202309181558064','PAID',1702191951548948480,'硬和谐',200.00,1,400.00,360.00,0,'money','2023-09-18 15:58:06','money','2023-09-18 15:58:06'),(1703698161548886016,'202309181711098','PAID',1701776231627407360,'软',99.00,1,12.00,11.00,0,'money','2023-09-18 17:11:10','money','2023-09-18 17:11:10'),(1703952545478258688,'202309191001597','PAID',1702191951548948480,'硬和谐',400.00,1,400.00,360.00,0,'money','2023-09-19 10:01:59','money','2023-09-19 10:01:59');
...
CREATE TABLE `oms_order_log` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='订单操作日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oms_order_log` VALUES (1656309547227369473,1656309547093151745,'完成订单','money','2023-05-10 22:45:43','money','2023-05-10 22:45:43'),(1701524747195170816,1701524747019010048,'完成订单','money','2023-09-12 17:14:47','money','2023-09-12 17:14:47'),(1701799861740584960,1701524747019010048,'<span style=\"color:red\">退单</span>','money','2023-09-13 11:28:00','money','2023-09-13 11:28:00'),(1701869395029737472,1701869394908102656,'完成订单','money','2023-09-13 16:04:18','money','2023-09-13 16:04:18'),(1703648056871432192,1701869394908102656,'<span style=\"color:red\">退单</span>','money','2023-09-18 13:52:04','money','2023-09-18 13:52:04'),(1703648878673997824,1703648878606888960,'完成订单','money','2023-09-18 13:55:20','money','2023-09-18 13:55:20'),(1703651178343772160,1703648878606888960,'<span style=\"color:red\">退单</span>','money','2023-09-18 14:04:28','money','2023-09-18 14:04:28'),(1703651946538938368,1703651946442469376,'完成订单','money','2023-09-18 14:07:31','money','2023-09-18 14:07:31'),(1703658539645087744,1703651946442469376,'<span style=\"color:red\">退货</span>硬和谐 X 1','money','2023-09-18 14:33:43','money','2023-09-18 14:33:43'),(1703679777599860736,1703679777574694912,'完成订单','money','2023-09-18 15:58:06','money','2023-09-18 15:58:06'),(1703696511425806336,1701524747019010048,'<span style=\"color:red\">清部分账</span>86.00','money','2023-09-18 17:04:36','money','2023-09-18 17:04:36'),(1703696706951675904,1701524747019010048,'<span style=\"color:red\">清部分账</span>86.00','money','2023-09-18 17:05:23','money','2023-09-18 17:05:23'),(1703698161636966400,1703698161502748672,'完成订单','money','2023-09-18 17:11:10','money','2023-09-18 17:11:10'),(1703703550814273536,1701524747019010048,'<span style=\"color:red\">清账</span>10','money','2023-09-18 17:32:34','money','2023-09-18 17:32:34'),(1703703604098711552,1701524747019010048,'<span style=\"color:red\">清账</span>75','money','2023-09-18 17:32:47','money','2023-09-18 17:32:47'),(1703704069741916160,1701524747019010048,'<span style=\"color:red\">清账</span>10','money','2023-09-18 17:34:38','money','2023-09-18 17:34:38'),(1703704711030026240,1701524747019010048,'<span style=\"color:red\">清账</span>100','money','2023-09-18 17:37:11','money','2023-09-18 17:37:11'),(1703704736200044544,1701524747019010048,'<span style=\"color:red\">清账</span>1002','money','2023-09-18 17:37:17','money','2023-09-18 17:37:17'),(1703705037510455296,1701524747019010048,'<span style=\"color:red\">清账</span>1','money','2023-09-18 17:38:29','money','2023-09-18 17:38:29'),(1703705055583711232,1701524747019010048,'<span style=\"color:red\">清账</span>11','money','2023-09-18 17:38:33','money','2023-09-18 17:38:33'),(1703952545612476416,1703952545440509952,'完成订单','money','2023-09-19 10:01:59','money','2023-09-19 10:01:59');
...
CREATE TABLE `sys_dict` (
  ...
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '字典描述',
  `create_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `create_time` datetime NOT NULL,
  `update_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `update_time` datetime NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='字典表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_dict_detail` (
  ...
  `update_time` datetime NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='字典详情表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_dict_detail` VALUES (1703662804732162048,'orderStatus','已支付','PAID',1,0,'money','2023-09-18 14:50:40','money','2023-09-18 14:52:56'),(1703663457462333440,'orderStatus','退单','RETURN',2,0,'money','2023-09-18 14:53:15','money','2023-09-18 14:53:15'),(1703663522394353664,'orderStatus','欠账','ARREARS',3,0,'money','2023-09-18 14:53:31','money','2023-09-18 14:53:31');
...
CREATE TABLE `sys_permission` (
  ...
  `update_time` datetime NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='资源权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_role` (
  ...
  `update_time` datetime NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='角色表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_role_permission_relation` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='角色资源权限关联表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_user_role_relation` (
  ...
  `role_id` bigint unsigned NOT NULL COMMENT '角色id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='用户角色关联表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-09-19 17:40:24
